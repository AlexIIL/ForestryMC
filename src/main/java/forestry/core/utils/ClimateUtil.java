...
public class ClimateUtil implements IClimateHelper {
	...
	public static void addHumidity(ClimateState state, ClimateState targetedState, float value){
	...
	public static void addTemperature(ClimateState state, ClimateState targetedState, float value){
